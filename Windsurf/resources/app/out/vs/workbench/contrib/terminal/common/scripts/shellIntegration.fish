...
# Allow override via ENABLE_IN_NON_VSCODE_TERMINALS for chisel/other tools
if not status is-interactive
	or begin; not string match --quiet "$TERM_PROGRAM" "vscode"; and test -z "$ENABLE_IN_NON_VSCODE_TERMINALS"; end
	or set --query VSCODE_SHELL_INTEGRATION
	exit
end
