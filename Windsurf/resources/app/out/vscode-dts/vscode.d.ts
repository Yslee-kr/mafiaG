...
declare module 'vscode' {
	...
	export interface SelectedCompletionInfo {
		 ...
		 */
		readonly additionalInfo?: windsurfAdditionalSelectedCompletionInfo;
	}

	/**
	 * Additional information about the completion item.
	 */
	export interface windsurfAdditionalSelectedCompletionInfo {
		/**
	...
	export interface Terminal {
		 ...
		 */
		sendSignal(signal: string): Thenable<void>;
	...
	/**
	 * An event signalling that shell integration injection was rejected for a terminal.
	 */
	export interface TerminalShellIntegrationInjectionRejectEvent {
		/**
		 * The terminal for which shell integration injection was rejected.
		 */
		readonly terminal: Terminal;

		/**
		 * The reason why shell integration injection was rejected.
		 */
		readonly reason: string;
	}
	...
	export interface WebviewOptions {
		...
		/**
		 * Controls whether fullscreen is enabled in the webview content or not.
		 *
		 * Defaults to false (fullscreen-disabled).
		 */
	...
	export namespace window {
		...
		/**
		 * This will be fired when shell integration injection is rejected for a terminal. The reason
		 * provides details about why the injection was rejected.
		 */
		export const onDidRejectTerminalShellIntegrationInjection: Event<TerminalShellIntegrationInjectionRejectEvent>;
	...
	export interface BasicSearchResult {
		...
		readonly path: string;
		/**
		 * The line number of the search result (1-indexed).
		 */
		readonly lineNumber: number;
		/**
	...
	/**
	 * An event that is fired when user has finished searching (only contains up to 50 results).
	 */
	export interface SearchCompleteEvent {
		 ...
		 */
		readonly results: BasicSearchResult[];
	}
	...
	export namespace workspace {
		...
		/**
		 * An {@link Event} which fires when the search has finished.
		 */
		export const onDidFinishSearch: Event<SearchCompleteEvent>;
