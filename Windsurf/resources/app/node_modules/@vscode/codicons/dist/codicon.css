...
@font-face {
	font-family: "codicon";
	font-display: block;
	src: url("./codicon.ttf?9853ab75f33151525ad47e2d1fb02eb7") format("truetype");
}
...
.codicon-cascade:before { content: "\f8fe" }
.codicon-cascade-browser:before { content: "\f8ff" }
.codicon-deepwiki:before { content: "\f900" }
