...
const re2js_1 = require("re2js");
const semver_1 = require("semver");
const helpers_1 = require("../helpers");
const variant_1 = require("../variant");
const MAX_REGEX_CACHE_SIZE = 100;
const regexCache = new lru_cache_1.LRUCache({ max: MAX_REGEX_CACHE_SIZE });
var Operator;
(function (Operator) {
    Operator["IN"] = "IN";
...
const RegexOperator = (constraint, context) => {
    const field = constraint.contextName;
    ...
    try {
        ...
        if (!regex) {
            regex = re2js_1.RE2JS.compile(value, constraint.caseInsensitive ? re2js_1.RE2JS.CASE_INSENSITIVE : undefined);
            regexCache.set(cacheKey, regex);
        }
        return regex.matcher(contextValue).find();
    }
    catch (_e) {
        return false;
    }
...
exports.Strategy = Strategy;//# sourceMappingURL=https://cdn.windsurf.com/sourcemaps/a65d6c4e1fd335336d7a0b601099811667e184ca/node_modules/unleash-client/lib/strategy/strategy.js.map