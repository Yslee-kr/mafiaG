...
description: "Customize and extend Devin for Terminal with rules, skills, and MCP servers"
icon: "puzzle-piece"
---
...
| `.claude/` directory | Commands, [custom subagents](/subagents#custom-subagents), [hooks](/extensibility/hooks/overview) |
