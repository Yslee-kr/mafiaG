---
title: "Configuration"
description: "How to configure Devin for Terminal behavior with config files"
icon: "gear"
---
...
<CardGroup cols={2}>
  <Card title="Model" icon="brain" href="/models">
  ...
  <Card title="MCP Servers" icon="server" href="/extensibility/mcp/configuration">
    Connect external tool servers for GitHub, Linear, databases, and any custom APIs.
  </Card>

  <Card title="External Tool Imports" icon="arrow-right-to-bracket" href="/extensibility/rules">
...
- **`hooks`** — lifecycle hooks ([see Hooks](/extensibility/hooks/overview))
...
<Note>
  Organization-level (enterprise) settings can **never** be overridden by project or user config. See [Configuration Precedence](/reference/configuration/global-vs-local) for full details on how merging works.
</Note>
...
<CardGroup cols={2}>
  <Card title="Full Config Reference" icon="file-code" href="/reference/configuration/config-file">
    Complete list of every configuration option and its format.
  </Card>

  <Card title="Configuration Precedence" icon="layer-group" href="/reference/configuration/global-vs-local">
