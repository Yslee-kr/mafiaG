...
description: "Supported terminals and recommendations for the best Devin for Terminal experience"
icon: "display"
---
...
| --- | --- | --- |
| [Kitty](https://sw.kovidgoyal.net/kitty/) | macOS†, Linux | Recommended for power users. Used by the developers of Devin for Terminal. |
| [Ghostty](https://ghostty.org/) | macOS†, Linux | Recommended for power users. Used by the developers of Devin for Terminal. |
